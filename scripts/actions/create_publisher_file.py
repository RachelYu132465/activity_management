...
def main(program_id_raw: str):
    ...
    for idx, person in enumerate(all_people, start=1):
        ...
        if isinstance(cur_pos, dict):
            ...
            org = person.get("organization") or person.get("affiliation") or ""
        ...
        draw_half_content(half_top, name, title, org, name_font, title_font, org_font, place_near_inner=True)
        draw_half_content(half_bottom, name, title, org, name_font, title_font, org_font, place_near_inner=True)
